...
import 'package:webtutorial/constants/style.dart';
...
AppBar(
        leading: !Responsiveness.isSmallScreen(context) ? Row(
          children: [
            Padding(
        ...
        title: Container(
          child: Row(
            ...
            Container(
              ...
              SizedBox(width: 24,),
              CustomText(text: "Salako Oluwaseun", color: lightGrey,size:16, weight:FontWeight.normal),
              SizedBox(width: 16,),
              Container(
                  decoration: BoxDecoration(
